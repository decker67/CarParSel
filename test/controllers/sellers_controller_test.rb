...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { city: @seller.city, firstName: @seller.firstName, lastName: @seller.lastName, phone: @seller.phone, street: @seller.street }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { city: @seller.city, firstName: @seller.firstName, lastName: @seller.lastName, phone: @seller.phone, street: @seller.street }
    assert_redirected_to seller_path(assigns(:seller))
  end
